...
//        setSupportActionBar(toolbar);
        ...
        if (extras != null) {
            String value = extras.getString("Bus_Track_Number");
            // textView.setText(value);            //The key argument here must match that used in the other activity
        }
...
////
////
////        if (id == R.id.track_buses) {
////
////
////        } else if (id == R.id.view_route_info) {
////
